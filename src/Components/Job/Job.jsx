    ...
    return (
        <div className="card card-compact  bg-base-100 shadow-xl">
            ...
            <div className="card-body">
                ...
                <div className="flex">
                    <h2 className="text-[#757575]"><AiOutlineDollar className="text-2xl mr-2" /></h2>
                    {salary}
                </div>
                </div>
                <div className="card-actions  ">
                   <Link to = {`/job/${id}`}><button className="btn btn-primary px-2 py-2 md:py-4 md:px-6">View Details</button></Link>
                </div>
            </div>
        </div>
    );
